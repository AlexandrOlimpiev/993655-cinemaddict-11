...
const creatMainContentTemplate = () => {
  return (
    `<section class="films">
...
const creatShowMoreTemplate = () => {
  return (
    `<button class="films-list__show-more">Show more</button>`
  );
};

const creatFooterStatsTemplate = () => {
  return (
